...
int row(char *text)
{
  if (text == "a1" || text == "a2" || text == "a3") return 0;
  if (text == "b1" || text == "b2" || text == "b3") return 1;
  if (text == "c1" || text == "c2" || text == "c3") return 2;
...
int col(char *text)
{
  if (text == "a1" || text == "b1" || text == "c1") return 0;
  if (text == "a2" || text == "b2" || text == "c2") return 1;
  if (text == "a3" || text == "b3" || text == "c3") return 2;
...
player won(game *g)
{
  ...
  if (line(a,b,c) == X) return X;
  if (line(d,e,f) == X) return X;
  if (line(k,h,i) == X) return X;
  if (line(a,d,k) == X) return X;
  if (line(b,e,h) == X) return X;
  if (line(c,f,i) == X) return X;
  if (line(a,e,i) == X) return X;
  if (line(c,e,k) == X) return X;


  if (line(a,b,c) == O) return O;
  if (line(d,e,f) == O) return O;
  if (line(k,h,i) == O) return O;
  if (line(a,d,k) == O) return O;
  if (line(b,e,h) == O) return O;
  if (line(c,f,i) == O) return O;
  if (line(a,e,i) == O) return O;
  if (line(c,e,k) == O) return O;
...
bool drawn(game *g)
{
  ...
  if (won(g) == O) return false;
  if (won(g) == X) return false;
  else return true;
}
